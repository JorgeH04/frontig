...
//import Avatar from '../Componentes/Avatar'; <Avatar usuario={usuario} />onClick= {() => deletePost(_id)}
...
export default function PostVista({ mostrarError, match, usuario }) {
  ...
  const deletePost = async (_id) => {
    ...
    const res = await fetch(`http://localhost:3000/api/posts/delete/${_id}`, {
      method: "DELETE",
    });
